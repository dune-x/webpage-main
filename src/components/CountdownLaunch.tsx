    ...
    return (
      <RevealFx translateY={10} delay={0.1} fillWidth horizontal="center">
        ...
        <style jsx>{`
          ...
          /* DESKTOP: 4 en línea, bien aireado */
          .timeGrid {
            width: 100%;
            max-width: 520px;
            display: grid;
          ...
          /* TABLET/MÓVIL: SIGUE EN UNA SOLA LÍNEA + SCROLL SUAVE si no cabe */
          @media (max-width: 900px) {
            ...
            /* Aquí está la clave: 1 fila siempre */
            .timeGrid {
              display: flex;
              flex-wrap: nowrap;
              gap: 14px;
              ...
              padding: 2px 2px 10px; /* bottom para que no “corte” sombras */
              scroll-snap-type: x mandatory;
            }

            .timeBox {
              flex: 0 0 auto;
              min-width: 110px; /* suficientemente grande para legibilidad */
              scroll-snap-align: center;
              padding: 12px 10px;
            }
          }

          /* Móvil pequeño: un pelín más compacto pero sin apelotonar */
